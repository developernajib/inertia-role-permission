...
<template>
    <div>
        <aside :class="[
            'fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition-all duration-300 ease-in-out',
            ...
            <div>
                <div class="-mx-6 px-6 py-4">
                    <a href="#" title="DeveloperNajib" class="flex justify-center">
                        <img src="@/assets/img/DevNajibLogo.png" class="w-36" alt="DeveloperNajib">
                    </a>
                </div>
                ...
                <ul class="space-y-2 tracking-wide mt-4">
                    ...
                    <li v-if="hasPermission('view.user')">
                    ...
                    <li v-if="hasPermission('view.role')">
                    ...
                    <li v-if="hasPermission('view.permission')">
                    ...
                    <li v-if="hasPermission('view.post')">
                        <SidebarLink :href="route('admin.posts.index')" :active="route().current('admin.posts.*')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
